...
use framepress_core::{default_registry, AdaptiveOptimizer, CompressionPreset, ScoredCandidate};
...
/// FramePress writes optimized images beside their inputs with this suffix.
